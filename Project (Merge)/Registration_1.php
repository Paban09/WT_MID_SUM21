...
echo "email: ".htmlspecialchars($_POST["email"])."<br>";
	...
	<body>
		...
		<fieldset>
		<legend align="center"><h1 style="background-color:DodgerBlue;"><b>Registration</b></h1></legend>
			<table>
...
<tr>
				...
				<tr>
				<td><button><a target="_blank" href="pmanager_1.php" >Product M. Register </a></button></td>
				<td >
